class Algorithms:
    """Класс алгоритмов определённый под использование объектами класса"""
    ...
    def quick_sorting(self, random_lst):
        if len(random_lst) < 2:
            return random_lst
        else:
            pivot = random_lst[0]
            ...
            return self.quick_sorting(less) + [pivot] + self.quick_sorting(greater)

    def dijkstras_algorithm(self, graph, costs, parents):
        processed = []
